        ...
        return (
            <Layout location={this.props.location} title={siteTitle}>
                ...
                <div className="job-wrapper">
                    {
                        jobs.map(({ node: { id, startDate, endDate, role, workplace, thumbnailDarkMode, thumbnailLightMode, body: { raw } } }, index) => {
                                ...
                                <div key={id} className="job-container">
                                    ...
                                    <div className="position-wrapper">
                                        <div className="position-container">
                                            <h2>{workplace}</h2>
                                            <p>{role}</p>
                                            <small><i>{formatDateToLocalTime(startDate)} - {endDateLabel}</i></small>
                                        </div>
                                        <Image
