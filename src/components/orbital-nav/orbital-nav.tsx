...
export function OrbitalNav({
    ...
    return (
        ...
        >
            ...
            />
            <div
                className={`absolute z-[29] bg-opacity-90 peer-checked:scale-75 drop-shadow-[0px_0px_10px_#000] ${ANIMATION_TIMING} col-start-1 row-start-1 flex h-16 w-16 items-center justify-center rounded-full bg-bright peer-checked:bg-darkest transition-all duration-500 peer-checked:rotate-90`}
            >
                <FaGripLines />
            </div>
            {navElements}
